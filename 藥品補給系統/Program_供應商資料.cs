    ...
    public partial class Form1 : Form
    {
        ...
        public string[] SQL_供應商資料_Data
        {
            get
            {
                ...
                SQL_供應商資料_Data[(int)enum_供應商資料.地址] = this.textBox_供應商資料_地址.Text;
                SQL_供應商資料_Data[(int)enum_供應商資料.訂單最低總金額] = this.textBox_供應商資料_訂單最低總金額.Text;
            ...
            set
            {
                ...
                this.textBox_供應商資料_地址.Text = value[(int)enum_供應商資料.地址];
                this.textBox_供應商資料_訂單最低總金額.Text = value[(int)enum_供應商資料.訂單最低總金額];
            }
        }
        private void Program_供應商資料_Init()
        {
            ...
            {
                Basic.MyMessageBox.ShowDialog("'供應商資料'Table未建立!");
        ...
        private void Function_供應商資料_登錄資料()
        {
            ...
            if (this.sqL_DataGridView_供應商資料.SQL_IsHaveMember(enum_供應商資料.序號.GetEnumName(), this.textBox_供應商資料_序號.Text))
            {
                ...
                {
                    this.sqL_DataGridView_供應商資料.SQL_Replace(enum_供應商資料.序號.GetEnumName(), this.textBox_供應商資料_序號.Text, this.SQL_供應商資料_Data, true);
                }
            }
            else
            {
        ...
        private List<string> Function_供應商資料_取得資料ListItems(object[] data)
        {
            ...
            List_str.Add("08.訂單最低總金額 : " + data[(int)enum_供應商資料.訂單最低總金額].ObjectToString());
        ...
        private bool Function_供應商資料_確認欄位正確(string[] SQL_Data, bool IsMyMessageBoxShow)
        {
            ...
            if (SQL_Data[(int)enum_供應商資料.序號].StringIsEmpty())
            {
                List_error_msg.Add("'序號'欄位空白");
            }

            if (SQL_Data[(int)enum_供應商資料.電話].StringIsEmpty())
            {
                List_error_msg.Add("'電話'欄位空白");
            }
            if (SQL_Data[(int)enum_供應商資料.聯絡人].StringIsEmpty())
            {
                List_error_msg.Add("'聯絡人'欄位空白");
            }
            if (SQL_Data[(int)enum_供應商資料.Email].StringIsEmpty())
            {
        ...
        private void plC_Button_供應商資料_刪除資料_btnClick(object sender, EventArgs e)
        {
            ...
            {
                List<object[]> obj_temp = this.sqL_DataGridView_供應商資料.Get_All_Select_RowsValues();
                if (obj_temp!= null)
                {
                    foreach (object[] value in obj_temp)
                    {
                        this.sqL_DataGridView_供應商資料.SQL_Delete(enum_供應商資料.序號.GetEnumName(), value[(int)enum_供應商資料.序號].ObjectToString(), false);
                    }
                }
        ...
        private void plC_Button_供應商資料_資料查詢_btnClick(object sender, EventArgs e)
        {
            ...
            {
                this.sqL_DataGridView_供應商資料.SQL_GetRowsByLike(enum_供應商資料.全名.GetEnumName(), comboBox_供應商資料_資料查詢_全名.Text, true);
            }
